...
export default function Hall5Visualizer({ language, onlyVisualizer = false, onNavigate }: { language: 'en' | 'ja', onlyVisualizer?: boolean, onNavigate?: (room: number) => void }) {
          ...
          <div>
            {!onlyVisualizer && (
              <>
                ...
                <div className="tied-foundations" style={{ marginTop: '0rem', marginBottom: '1.5rem', borderTop: '1px solid rgba(255,255,255,0.06)', paddingTop: '1rem' }}>
